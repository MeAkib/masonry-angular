...
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/gallery`     | The everyday case: responsive breakpoints, mixed-height cards, images the grid waits on before positioning, entry animation, live geometry readout.             |
...
| `/dashboard`   | Twenty fixed-size tiles — pixel height, width in whole columns — with every body behind `@defer (on viewport)`, so bodies load on scroll without moving a tile. |
