  ...
  template: `
    <demo-example [code]="code">
      <p class="lede" lede>
        ...
        <code>masonryGridStamp</code> element is positioned by you and treated as an obstacle.
        <code>horizontalOrder</code> switches from shortest-column packing to strict row order.
      </p>
...
export class SpansExample {
  readonly code = `<!-- Widen an item with masonryColSpan, never with CSS width:
